...
const Hero = ({ addToCart, cartItems }) => {
  const [isOpen, setIsOpen] = useState(false);
  const products = [
    { id: 1, name: "Chicken", price: 69, image: "https://i.ibb.co/cF9LXJj/chicken.jpg", description: "Chicken Fajitas served with rice and beans", new: true },
    { id: 2, name: "Fajitas", price: 169, image: "https://i.ibb.co/Mh7HmKW/Fajitas.jpg", description: "Chicken Fajitas served with rice and beans" },
    { id: 3, name: "Chicken Masala", price: 269, image: "https://i.ibb.co/ggr7yM7/Chicken-Masala.jpg", description: "Chicken Masala served with rice and beans", new: true },
  ];
    ...
    <section className="container py-8 px-8">
      <div className="container px-4 md:px-0">
        ...
        <p className="text-center pb-4 text-gray-500 text-xs">
          Menu <span className="text-red-500">&gt;</span> CHICKEN CRISPER® COMBOS
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 justify-items-center">
          {products.map((product) => {
            ...
            return (
              <div key={product.id} className="bg-white p-5 rounded-lg shadow-md flex flex-col items-center gap-2 relative max-w-md">
                {product.new && (
                ...
                <img src={product.image} alt={product.name} className="w-full h-36 object-cover mb-1 rounded-md" />
                <div className="text-start">
                  <p className="text-lg font-semibold">{product.name}</p>
                  <p className="text-gray-600 pb-2">{product.price}$/each</p>
                ...
                <button
                  ...
                  className={`mt-4 w-full font-medium py-1 rounded ${
                    isInCart ? "bg-gray-500 text-white" : "bg-red-500 text-white hover:bg-gray-500"
                  }`}
                  disabled={isInCart}
                >
